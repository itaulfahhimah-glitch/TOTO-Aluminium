    ...
    <section id="calculator" className="py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          {/* Controls Form Side */}
          <div className="lg:col-span-7 bg-white border border-slate-200/85 rounded-2xl p-6 sm:p-8 shadow-sm space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-slate-600 tracking-wide uppercase">Jenis Pekerjaan</label>
                <select
                  value={state.workType}
                  onChange={(e) => handleInputChange("workType", e.target.value)}
                  className="w-full bg-slate-50 hover:bg-slate-100/50 border border-slate-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-sky-500 transition-colors"
                >
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-slate-600 tracking-wide uppercase">Merk Aluminium</label>
                <select
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-slate-600 tracking-wide uppercase">Warna Kusen</label>
                <select
                  value={state.color}
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-slate-600 tracking-wide uppercase">Jenis Kaca</label>
                <select
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 bg-slate-50 p-4 rounded-xl border border-slate-200/50">
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-slate-600 tracking-wide uppercase">Lebar (cm)</label>
                <input
                  type="number"
                  min="30"
                  max="1000"
                  ...
                  className="w-full bg-white border border-slate-200 rounded-lg px-3.5 py-2.5 text-sm font-semibold text-slate-800 focus:outline-none focus:border-sky-500 transition-colors"
                />
              </div>

              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-slate-600 tracking-wide uppercase">Tinggi (cm)</label>
                <input
                  type="number"
                  min="30"
                  max="1000"
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-slate-600 tracking-wide uppercase">Jumlah (unit)</label>
                <input
                  type="number"
                  min="1"
                  max="50"
            ...
            <div className="flex items-start space-x-3 bg-sky-50/60 border border-sky-100 p-4 rounded-xl">
              <Info className="w-5 h-5 text-sky-500 shrink-0 mt-0.5" />
              <div className="text-[11px] sm:text-xs text-sky-700 leading-relaxed">
          ...
          <div className="lg:col-span-5 bg-slate-900 text-white rounded-2xl p-6 sm:p-8 border border-slate-800 shadow-xl space-y-6 flex flex-col justify-between self-stretch">
            ...
            <div className="space-y-2 pt-6 border-t border-slate-800">
              ...
              <button
                ...
                className="w-full flex items-center justify-center space-x-2 bg-slate-850 hover:bg-slate-800 border border-slate-850 text-white font-display font-bold text-xs tracking-wider uppercase py-3 rounded-xl transition-all"
              >
